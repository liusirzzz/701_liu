...
@torch.no_grad()
def run(
        weights='yolo_lprnet/master_liu/yolov5s.pt',  # model.pt path(s)
        source='yolo_lprnet/master_liu/data/images',  # file/dir/URL/glob, 0 for webcam
        data='yolo_lprnet/master_liu/data/coco128.yaml',  # dataset.yaml path
        ...
        project='yolo_lprnet/master_liu/runs/detect',  # save results to project/name
...
def parse_opt():
    ...
    parser.add_argument('--project', default='yolo_lprnet/master_liu/runs/detect', help='save results to project/name')
